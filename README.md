...
- 自动构建 Tauri 桌面端时，如果缺少 Rust/cargo-xwin，发布脚本会默认尝试自动安装，并默认使用 rsproxy Rust/Cargo 国内镜像；如需禁用自动安装可设置 `ASR_RELEASE_AUTO_INSTALL_RUST=0`，如需禁用镜像可设置 `ASR_RELEASE_USE_RUST_MIRROR=0`
