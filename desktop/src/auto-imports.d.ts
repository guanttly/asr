...
declare global {
  ...
  const isRecorderDeviceNotFound: typeof import('./composables/useAudioRecorder')['isRecorderDeviceNotFound']
  const isRef: typeof import('vue')['isRef']
  const mapActions: typeof import('pinia')['mapActions']
  const mapGetters: typeof import('pinia')['mapGetters']
  const mapRecorderError: typeof import('./composables/useAudioRecorder')['mapRecorderError']
...
declare global {
  ...
  // @ts-ignore
  export type { SceneMode, ProductCapabilities, VoiceControlConfig, ProductLanguageOption } from './stores/app'
  import('./stores/app')
}
