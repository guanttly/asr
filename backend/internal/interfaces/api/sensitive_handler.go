...
func (h *SensitiveHandler) writeError(c *gin.Context, err error) {
	...
	case errors.Is(err, appsensitive.ErrSensitiveBaseDictProtected), errors.Is(err, appsensitive.ErrSensitiveBaseDictConflict), errors.Is(err, appsensitive.ErrSensitiveEntryDuplicate), errors.Is(err, appsensitive.ErrSensitiveDictInUse):
