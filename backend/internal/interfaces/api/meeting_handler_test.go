...
func TestCreateMeetingRejectsNonMeetingWorkflow(t *testing.T) {
	...
	handler := NewMeetingHandler(nil, workflowSvc, nil, "uploads", "", 100, 8, pkgconfig.ProductConfig{Edition: pkgconfig.ProductEditionAdvanced}.Features())
...
func TestDeleteMeetingAllowsCompletedMeeting(t *testing.T) {
	...
	handler := NewMeetingHandler(service, nil, nil, "uploads", "", 100, 8, pkgconfig.ProductConfig{Edition: pkgconfig.ProductEditionAdvanced}.Features())
